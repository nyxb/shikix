...
describe('should', () => {
   it('works', async () => {
      ...
      const hast = shiki.codeToHast('console.log\nfoo.bar', { lang: 'js', theme: 'lumos-light' })

      expect(toHtml(hast))
         .toMatchInlineSnapshot(`
        "<pre class="shiki lumos-light" style="background-color:#ffffff;color:#393a34" tabindex="0"><code><span class="line"><span style="color:#B07D48">console</span><span style="color:#999999">.</span><span style="color:#B07D48">log</span></span>
   ...
   it('hast transformer', async () => {
      ...
      expect(warn.mock.calls[0][0])
         .toMatchInlineSnapshot('"[shikix] `transforms` option is deprecated, use `transformers` instead"')
   })
})
...
it('render whitespace', async () => {
   ...
   expect(code)
      .toMatchInlineSnapshot(`
      "<pre class="shiki lumos-light" style="background-color:#ffffff;color:#393a34" tabindex="0"><code><span class="line"><span style="color:#59873A">  space</span><span style="color:#999999">()</span></span>
